...
class _MapScreenState extends State<MapScreen>{
  ...
  Future getData() async{
    QuerySnapshot querySnapshot = await FirebaseFirestore.instance.collection('repairShop').get();
                                    ...
                                    return Container(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(
                                          children: [
                                            Container(
                                              child: Text('${data[0]['name']}', style: TextStyle(fontSize: 20, color: Colors.blueAccent),),
                                            ),
                                            Container(
                                              width: double.infinity,
